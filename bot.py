...
if not WEBHOOK_URL:
    raise ValueError("WEBHOOK_URL обязателен (например, https://your-app.onrender.com/webhook)")
...
async def main():
    ...
    # Запускаем веб-сервер для приёма webhook
    ...
    app.web_app.router.add_post('/webhook', webhook)
